...
const cafes: Cafe[] = [
  {
    ...
    studyScore: 9,
    priceRange: "$$",
    comments: ["Güzel Kahve", "Sessiz Sakin", "Hızlı Wi-Fi"]
  },
  {
    name: "Seaside Sips",
    ...
    studyScore: 6,
    priceRange: "$$$",
    comments: ["Deniz kenarı manzarası", "Kalabalık", "Güzel tatlılar"]
  },
  {
    name: "Quiet Corner",
    ...
    studyScore: 10,
    priceRange: "$",
    comments: ["Çalışmak için mükemmel", "Sınırılı yiyecek opsiyonları", "Her zaman oturacak yer var"]
  }
]
...
export default function page() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h1 className="text-3xl font-bold mb-6">DAÜ etrafindaki restoranlar</h1>
