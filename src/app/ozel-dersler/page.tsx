...
const privateClasses: PrivateClass[] = [
  ...
  },
  {
    ...
    name:"CMPE231",
    price:400,
    contactLink:"https://www.instagram.com/ccakmakfurkan?igsh=Mnl5YjZmZmw2Y2t1"
...
export default function page() {
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <h1 className="text-4xl font-bold text-gray-900 mb-8">Özel Dersler</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {privateClasses.map((classItem) => (
          <div key={classItem.id} className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 p-6 border border-gray-200">
            ...
            <p className="text-lg text-gray-700 mb-4">Fiyat: <span className="font-medium">{classItem.price} TL</span></p>
            <a 
