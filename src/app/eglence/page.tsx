...
const entertainments: Entertainment[] = [
  ...
  },
  {
    ...
    priceRange: '$$$',
    comments: ['Bowling, bilardo ve futbol maçları', 'Harika yiyecekler ve kokteyller', 'İyi nargile'],
  },
  {
    id: 7,
    name: 'De Molay Bar',
    ...
    priceRange: '$$',
    comments: ['Rahat ve huzurlu atmosfer', 'İyi şovlar ve canlı müzik', 'Kaliteli kokteyller'],
  },
  {
    id: 8,
    name: 'Monks Inn',
    ...
    priceRange: '$$',
    comments: ['Premium kokteyller', 'Rahat ortam', 'İyi dış mekan oturma alanı'],
  },
  {
    id: 9,
  ...
  },
  {
    ...
    priceRange: '$$',
    comments: ['Canlı müzik', 'Kaliteli kokteyller', 'Rahat dış mekan oturma alanı'],
  },
  {
    id: 11,
    name: '42 Café & Bar',
  ...
  },
  {
    ...
    priceRange: '$',
    comments: ['Temiz deniz', 'İyi kaliteli yiyecekler ve servis', 'Güler yüzlü'],
  },
  {
    id: 15,
    name: 'Loof Beach',
    ...
    priceRange: '$$$',
    comments: ['Temiz deniz', 'İyi kaliteli kahve ve yiyecekler', 'Harika şovlar ve açık hava sineması'],
  },
  {
    id: 16,
    ...
    priceRange: '$$$',
    comments: ['İyi patlamış mısır', 'Kaliteli salonlar ve ses sistemleri', 'Güler yüzlü'],
  },
]
